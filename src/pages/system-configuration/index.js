...
import { Row, Col, Card, CardHeader, CardBody, Input, Button, FormGroup, Label } from 'reactstrap'
  ...
  function updateConfig() {
    const dataUpdate = {
      data: {
        ...
        enableStakingModule: data.enableStakingModule || 0
      }
    }

    if (data.enableStakingModule < 0 && data.enableStakingModule > 100) {
  ...
  function handleChangeLinkSupport(type, value) {
    switch (type) {
      ...
      case 'messenger':
        ...
        setData({ ...data })
        break
      case 'enableStakingModule':
        data.enableStakingModule = value
        setData({ ...data })
        break
      default:
        break
        ...
        <div className={'container-config'}>
          ...
          <div className={'info-image'}>
            <div className={'container-image px-1'}>
              <Row className={'container-input'}>
                ...
                <Col lg={3}>
                  {data?.bannerImage2 && (
                    <>
                      <div className={'container-input-file'}>
                        <Trash2 className={'icon-remove'} onClick={() => handleRemoveImage('2')} />
                        <img
                ...
                <Col lg={3}>
                  {data?.bannerImage3 && (
                    <>
                      <div className={'container-input-file'}>
                        <Trash2 className={'icon-remove'} onClick={() => handleRemoveImage('3')} />
                        <img
                ...
                <Col lg={3}>
                  {data?.bannerImage4 && (
                    <>
                      <div className={'container-input-file'}>
                        <Trash2 className={'icon-remove'} onClick={() => handleRemoveImage('4')} />
                        <img
                ...
                <Col lg={3}>
                  {data?.bannerImage5 && (
                    <>
                      <div className={'container-input-file'}>
                        <Trash2 className={'icon-remove'} onClick={() => handleRemoveImage('5')} />
                        <img
              ...
              <p className={'guide-content'}>Định dạng hình ảnh: PNG, JPG. Dung lượng hình không được quá 1.0MB.</p>
            </div>
          </div>
          ...
          <div className={'container-input__setting'}>
            ...
            <div>
              <Cleave
                ...
                onChange={e => handleChangeLinkSupport('telegram', e.target.value)}
            ...
            <div>
              <Cleave
                className={'form-control form-control__common'}
                onChange={e => handleChangeLinkSupport('messenger', e.target.value)}
            ...
            <h3>Tỉ lệ win ( 0 - 100 )</h3>
            <div>
              <Cleave
                className={'form-control form-control__common'}
                onChange={e => handleChangeLinkSupport('enableStakingModule', e.target.value)}
                value={data?.enableStakingModule}
              />
            </div>
          </div>
          <div className={'text-right'}>
            <Button className={'btn-save'} color={'primary'} onClick={() => updateConfig()}>
              Lưu
            </Button>
          </div>
        </div>
